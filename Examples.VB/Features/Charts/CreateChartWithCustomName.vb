Namespace Features.Charts
    Public Class CreateChartWithCustomName
        Inherits ExampleBase
        Public Overrides Sub Execute(workbook As Excel.Workbook)
            Dim worksheet As IWorksheet = workbook.Worksheets(0)

            Dim shape As IShape = worksheet.Shapes.AddChart("Area chart", ChartType.Area, 250, 20, 360, 230)
            ...
            'Get chart by name
            Dim areaChart As IShape = worksheet.Shapes("Area chart")
