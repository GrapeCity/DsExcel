...
namespace GrapeCity.Documents.Excel.Examples.Templates
{
    public class TemplateWorkWithConditionalFormatting : ExampleBase
    {
        public override void Execute(GrapeCity.Documents.Excel.Workbook workbook)
        {
            //Load template file from resource
            var templateFile = this.GetResourceStream("xlsx\\Template_WorkWithConditionalFormatting.xlsx");
        ...
        public override string TemplateName
        {
            get
            {
                return "Template_WorkWithConditionalFormatting.xlsx";
            }
        }
        ...
        public override string[] UsedResources
        {
            get
            {
                return new string[] { "xlsx\\Template_WorkWithConditionalFormatting.xlsx" };
            }
        }
