...
namespace GrapeCity.Documents.Excel.Examples.Templates.Properties
{
    public class SetExpansionType : ExampleBase
    {
        public override void Execute(GrapeCity.Documents.Excel.Workbook workbook)
        {
            //Load template file Template_Score.xlsx from resource
            var templateFile = this.GetResourceStream("xlsx\\Template_SetExpansionType.xlsx");
        ...
        public override string TemplateName
        {
            get
            {
                return "Template_SetExpansionType.xlsx";
            }
        }
        ...
        public override string[] UsedResources
        {
            get
            {
                return new string[] { "xlsx\\Template_SetExpansionType.xlsx" };
            }
        }
    }
}
