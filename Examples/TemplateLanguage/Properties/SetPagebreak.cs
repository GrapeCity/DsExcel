...
{
    public class SetPagebreak : ExampleBase
    {
        public override void Execute(GrapeCity.Documents.Excel.Workbook workbook)
        {
            //Load template file Template_Score.xlsx from resource
            var templateFile = this.GetResourceStream("xlsx\\Template_SetPagebreak.xlsx");
        ...
        public override string TemplateName
        {
            get
            {
                return "Template_SetPagebreak.xlsx";
            }
        }
        ...
        public override string[] UsedResources
        {
            get
            {
                return new string[] { "xlsx\\Template_SetPagebreak.xlsx" };
            }
        }
    }
}
