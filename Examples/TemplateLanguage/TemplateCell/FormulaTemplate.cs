...
{
    public class FormulaTemplate : ExampleBase
    {
        public override void Execute(GrapeCity.Documents.Excel.Workbook workbook)
        {
            //Load template file from resource
            var templateFile = this.GetResourceStream("xlsx\\Template_FormulaTemplate.xlsx");
        ...
        public override string TemplateName
        {
            get
            {
                return "Template_FormulaTemplate.xlsx";
            }
        }
        ...
        public override string[] UsedResources
        {
            get
            {
                return new string[] { "xlsx\\Template_FormulaTemplate.xlsx" };
            }
        }
