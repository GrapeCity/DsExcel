...
namespace GrapeCity.Documents.Excel.Examples.Templates.Style
{
    public class MergeCell : ExampleBase
    {
        public override void Execute(GrapeCity.Documents.Excel.Workbook workbook)
        {
            //Load template file from resource
            var templateFile = this.GetResourceStream("xlsx\\Template_MergeCell.xlsx");
        ...
        public override string TemplateName
        {
            get
            {
                return "Template_MergeCell.xlsx";
            }
        }
        ...
        public override string[] UsedResources
        {
            get
            {
                return new string[] { "xlsx\\Template_MergeCell.xlsx" };
            }
        }
    }
}
