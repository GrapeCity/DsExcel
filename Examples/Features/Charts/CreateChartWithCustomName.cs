...
{
    public class CreateChartWithCustomName : ExampleBase
    {
        public override void Execute(GrapeCity.Documents.Excel.Workbook workbook)
        {
            IWorksheet worksheet = workbook.Worksheets[0];
            GrapeCity.Documents.Excel.Drawing.IShape shape = worksheet.Shapes.AddChart("Area chart", GrapeCity.Documents.Excel.Drawing.ChartType.Area, 250, 20, 360, 230);
            ...
            //Get chart by name
            GrapeCity.Documents.Excel.Drawing.IShape areaChart = worksheet.Shapes["Area chart"];
            areaChart.Chart.SeriesCollection.Add(worksheet.Range["A1:C13"], GrapeCity.Documents.Excel.Drawing.RowCol.Columns);
